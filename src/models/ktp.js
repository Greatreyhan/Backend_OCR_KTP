...
const createKTPRecord = (body)=>{
    const SQLQuery = `INSERT INTO ktp (nik, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, golongan_darah, alamat, rt_rw, kelurahan, kecamatan, agama, status_perkawinan, pekerjaan, kewarganegaraan, filename)
                      VALUES ('${body.nik}','${body.nama}','${body.tempat_lahir}','${body.tanggal_lahir}','${body.jenis_kelamin}','${body.golongan_darah}','${body.alamat}','${body.rt_rw}','${body.kelurahan}','${body.kecamatan}','${body.agama}','${body.status_perkawinan}','${body.pekerjaan}','${body.kewarganegaraan}','${body.filename}')`
